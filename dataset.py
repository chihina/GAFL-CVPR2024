...
def return_dataset(cfg):
    if cfg.dataset_name=='volleyball':
        ...
        if cfg.use_jae_loss:
            train_anns = volley_read_dataset_jae(cfg.jae_ann_dir, train_anns)
        train_frames = volley_all_frames(train_anns)

        test_anns = volley_read_dataset(cfg.data_path, cfg.test_seqs)
        if cfg.use_jae_loss:
            test_anns = volley_read_dataset_jae(cfg.jae_ann_dir, test_anns)
        ...
        training_set=VolleyballDataset(all_anns,all_tracks,train_frames,
                                      cfg.data_path,cfg.image_size,cfg.person_size,cfg.out_size,cfg.inference_module_name,num_before=cfg.num_before,
        ...
        training_set=CollectiveDataset(train_anns,train_frames,
                                      cfg.data_path,cfg.image_size,cfg.person_size,cfg.out_size,
