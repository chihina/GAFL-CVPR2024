...
class My3DResNet18(nn.Module):
    def __init__(self, pretrained=True):
        super(My3DResNet18, self).__init__()
...
def _video_resnet(
    ...
    **kwargs: Any,
    ...
    model.load_state_dict(torch.load(os.path.join('pretrained_weights', 'r3d_18-b3b3357e.pth')))
...
def r3d_18(*, weights = None, progress: bool = True, **kwargs: Any) -> VideoResNet:
