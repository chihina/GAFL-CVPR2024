...
cfg.cluster_center_type = 'mean'
# cfg.cluster_center_type = 'median'

# cfg.mask_act_type = 'backprop_energy_original'
cfg.mask_act_type = 'backprop_original'
# cfg.mask_act_type = 'perturbation_original'
# cfg.mask_act_type = 'random'

# cfg.use_debug = False
cfg.use_debug = True
if cfg.use_debug:
    cfg.debug_sample = 1337
    # cfg.debug_sample = 100
