...
# cfg.stage1_model_path = 'result/[GR ours_stage1]<2023-07-07_23-22-44>/stage1_epoch10_0.59%.pth'
# cfg.exp_note = 'GR ours rand mask 5 wo finetune jae'
# cfg.exp_note = 'GR ours rand mask 5 wo finetune jae w backbone pretrain'
cfg.exp_note = 'GR ours recon feat random mask 6 wo finetune jae'
# cfg.exp_note = 'GR ours recon feat random mask 6 wo finetune jae w backbone pretrain'
# cfg.load_backbone_stage3 = True
# cfg.exp_note = 'GR ours rand mask 5 w finetune jae'
# cfg.exp_note = 'GR ours recon feat random mask 6 w finetune jae'
